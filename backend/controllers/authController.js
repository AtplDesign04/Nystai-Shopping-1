...
exports.registerUser = catchAsyncError(async (req, res, next) => {
    ...
    const htmlMessage = `<p>Please click the following link to verify your email:</p><a href="${verificationLink}">${verificationLink}</a>`;
...
exports.createSavedAddress = catchAsyncError(async (req, res, next) => {
    ...
    // If the address doesn't exist, add it to the user's saved addresses
    user.savedAddress.push(req.body);
    await user.save();
