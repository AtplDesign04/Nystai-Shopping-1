...
export default function ProductCategory() {
    ...
    useEffect(() => {
        ...
        const subcategoryParams = activeSubcategory && activeSubcategory !== 'All' ? `${activeSubcategory}` : '';
                            ...
                            <div className="row mt-3">
                                <div className="container mt-5">
                                    <div className="subcategory-section">
                                        ...
                                        <div className="subcategory-dropdown" ref={subcategoryDropdownRef}>
                                            <div
                                            ...
                                            <div className={`dropdown-menu ${isSubcategoryDropdownOpen ? 'show' : ''}`}>
                                                {subcategories.map((subCat) => (
