...
import { productsRequest, productsSuccess, productsFail, adminProductsSuccess, adminProductsFail} from '../slices/productSlice';
...
import { adminOrdersRequest } from '../slices/orderSlice';
export const getProducts =(keyword, price, category, subcategory,rating, currentPage, ) => async (dispatch) => {
    try {  
